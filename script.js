...
/* --------- */
let menuItems,
    rowOfertas = document.querySelector("#row-ofertas"),
    rowHombres = document.querySelector("#row-hombres"),
    rowMujeres = document.querySelector("#row-mujeres"),
    rowNiños = document.querySelector("#row-niños"),
    ...
    validUser = {user: "andypallero1", pass: "andy1234"},
...
function updateOrder(clean) {
    ...
    order = [];
    form.innerHTML = '<input type="hidden" name="_next" value="https://"><input type="hidden" name="_captcha" value="false">'; 
...
function createSettingsRow(type, description, price, available, source) {
    ...
    option1.value = "Ofertas";
    option1.textContent = "Ofertas";
    ...
    option3.value = "Mujeres";
    option3.textContent = "Mujeres";
    inputType.appendChild(option3);
    let option4 = document.createElement("option");
    option4.value = "Niños";
    option4.textContent = "Niños";
...
function createMenuAndSettings(products) {
    ...
    rowOfertas.innerHTML = "";
    rowHombres.innerHTML = "";
    rowMujeres.innerHTML = "";
    rowNiños.innerHTML = "";
